...
namespace ProcessingTools.Console.PowerShell
{
    using System;
    ...
    public class PowerShellScriptInvoker
    {
        ...
        private void OutputCollection_DataAdded(object sender, DataAddedEventArgs e)
        {
            ...
            this.logger.LogDebug($"Object {e.PowerShellInstanceId}({e.Index}) added to output.");
        }
        ...
        private void Error_DataAdded(object sender, DataAddedEventArgs e)
        {
            ...
            this.logger.LogDebug($"An error was written to the Error stream {e.PowerShellInstanceId}({e.Index})!");
        }
